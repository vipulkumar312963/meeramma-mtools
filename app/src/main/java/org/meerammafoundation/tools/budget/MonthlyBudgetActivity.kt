...
class MonthlyBudgetActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.budget_activity_monthly_budget)
    ...
    private fun saveData() {
        ...
        editor.apply()
        Toast.makeText(this, "Budget data saved", Toast.LENGTH_SHORT).show()
    }
    ...
    private fun loadData() {
        ...
        Toast.makeText(this, "Budget data loaded", Toast.LENGTH_SHORT).show()
    }
